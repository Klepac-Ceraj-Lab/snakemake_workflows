...
rule humann2_rename_gf:
    input: os.path.join(humannfolder, "main", "{sample}_genefamilies.tsv")
    output: os.path.join(humannfolder, "names", "{sample}_genefamilies_names.tsv"),
    run:
...
rule humann2_rename_ecs:
    ...
    output: os.path.join(humannfolder, "names", "{sample}_ecs_names.tsv"),
    run:
...
rule humann2_report:
    input:
        expand(os.path.join(humannfolder, "names", "{sample}_genefamilies_names.tsv"), sample=samples),
        expand(os.path.join(humannfolder, "names", "{sample}_ecs_names.tsv"), sample=samples),
    output:
