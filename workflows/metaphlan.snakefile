...
rule metaphlan:
    ...
    run:
        shell("metaphlan {input} {output.profile} --bowtie2out {output.bowtie} --samout {output.sam} --input_type fastq --nproc 8 --bowtie2db /nobackup1/vklepacc/databases/chocophlan") # TODO: get nproc from settings
